...
namespace BSIMM.Avalonia.Views
{
    public partial class FilterBuilderWindow : Window
    {
        ...
        private Border CreateEmptyPlaceholder()
        {
            ...
            stack.Children.Add(new TextBlock { Text = "点击上方「添加条件组」开始构建筛选条件", FontSize = 13, Foreground = GetBrush("TextSecondaryBrush"), HorizontalAlignment = HorizontalAlignment.Center });
