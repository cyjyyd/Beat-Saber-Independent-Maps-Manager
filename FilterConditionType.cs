    ...
    public static class FilterConditionMetadata
    {
        private static readonly Dictionary<FilterConditionType, (string DisplayName, FilterValueType ValueType, List<string> Options)> _metadata =
            new Dictionary<FilterConditionType, (string, FilterValueType, List<string>)>
            {
                ...
                // BPM - use Range type only (MinBpm/MaxBpm removed from UI, kept for backward compatibility)
                { FilterConditionType.Chroma, ("Chroma", FilterValueType.Boolean, null) },
                { FilterConditionType.Noodle, ("Noodle Extensions", FilterValueType.Boolean, null) },
                ...
                // Range-type filters (simplified UI - from 200)
        ...
        public static Dictionary<string, List<FilterConditionType>> GetGroupedConditions()
        {
            return new Dictionary<string, List<FilterConditionType>>
            {
                ...
                { "Mod支持", new List<FilterConditionType> { FilterConditionType.Chroma, FilterConditionType.Noodle, FilterConditionType.Me, FilterConditionType.Cinema, FilterConditionType.Vivify, FilterConditionType.CustomMod, FilterConditionType.ExcludeCustomMod } },
        ...
        /// <summary>
        /// Gets all filter condition types as a flat list (derived from metadata)
        /// </summary>
        public static List<FilterConditionType> GetAllConditions() => _metadata.Keys.ToList();
        ...
        /// <summary>
        /// Gets all local cache-specific condition types (types with value >= 100)
        /// </summary>
        public static List<FilterConditionType> GetLocalCacheConditions() =>
            _metadata.Keys.Where(t => (int)t >= 100).ToList();
    }
}